...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  ////NSLog([XFramework helloWorld]);
  //[XFramework initFramework];
  ...
  //set
  self.window.rootViewController = [SimpleMainFramework initUI:launchOptions];
  self.window.backgroundColor = XColorRGB(246, 246, 246);
