...
var query = function (req, res, next) {
    ...
    user.find(params, function(error, records){
...
var queryOne = function (req, res, next) {
    ...
    var params = req.query;
    console.log("-------------get url params:" + JSON.stringify(params));
    user.findOne(params, function(error, record){
...
var update = function (req, res, next) {
    ...
    user.update({_id:req.body._id},params, function(error, records){
        console.log(JSON.stringify(records));
        var result = {
            msg:"success",
            success:true,
...
var remove = function (req, res, next) {
    ...
    user.remove({_id:req.body._id}, function(error, records){
        console.log(JSON.stringify(records));
        var msg = 'success';
        var success = true;
        if(error) {
...
var createNew = function (req, res, next) {
    ...
    user.create(params, function(error, record){
        console.log(JSON.stringify(record));
        var result = {
            msg:"success",
            success:true,
