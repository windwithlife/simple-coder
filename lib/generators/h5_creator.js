...
var config = {
    ...
    targetWebRootResourcePath:function(){return this.targetWebRootPath() + "resources/pc/"},
    ...
    targetModuleControllerPath:function(){return this.targetWebRootResourcePath()  + this.module + "/";},
