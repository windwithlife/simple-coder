...
var config = {
    ...
    //代码生成目标目录---网站基本目录
    targetWebRootViewPath:function(){return this.targetWebRootPath() + "views/"},
    targetWebRootBinPath:function(){return this.targetWebRootPath() + "bin/"},
    targetWebRootResourcePath:function(){return this.targetWebRootPath() + "resource/"},

    //代码生成目标目录---每个模块目录
    targetModuleRootPath:function(){return this.targetWebRootResourcePath()  + this.module;},
    targetModuleModelPath:function(){return this.targetWebRootResourcePath()  + this.module + "/models/";},
    targetModuleRouterPath:function(){return this.targetWebRootResourcePath()  + this.module + "/";},
    targetModuleConfigPath:function(){return this.targetWebRootResourcePath()  + this.module + "/";},
    targetModuleViewTemplatePath:function(){return this.targetWebRootResourcePath()  + this.module + "/templates/";},
    targetModuleControllerPath:function(){return this.targetWebRootResourcePath()  + this.module + "/controllers/";},
