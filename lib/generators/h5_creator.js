...
var config = {
    ...
    language : "h5",
    framework:"simple",
    basePackage:"simple-base/src/main/java/com/simple/base",
    //dbType:"mongodb",
    //root path define
    rootModulePath: function(){return this.rootPath +"/modules/";},
    serverRootPath:function(){return this.rootPath + "server/"},
    serverBZRootPath:function(){return this.serverRootPath()+ this.basePackage + "/bz/"},
    webRootPath:function(){return this.rootPath + "server/simple-base/src/main/resources/web/"},
