...
var config = {
    ...
    targetWebRootPath:function(){return path.join(this.targetRootPath, "/",this.language,"x/")},
    ...
    workControllerTemplatePath:function(){return path.join(this.templatePath() ,"view",this.endName, "/");},
...
exports.coderDefine = {name:"rj-no-redux",desc:"create a react js framework and related project code"};
