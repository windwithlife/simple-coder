...
var config = {
    ...
    framework:"",
    dbType:"mongodb",
    clientRootPath: function(){return this.rootPath +"client/";},
    srcRootPath: function(){return this.clientRootPath() +"src/";},
    rootModulePath: function(){return this.rootPath +"/modules/";},
    webRootPath:function(){return this.clientRootPath() + "web/"},
    iosRootPath:function(){return this.clientRootPath() + "ios/"},
    androidRootPath:function(){return this.clientRootPath() + "android/"},
...
function copyBaseFrameworkFiles(){
    ...
    xtools.copyDirEx(frameworkBinPath,config.srcRootPath());
    var frameworkPath = config.rootTemplatePath() + "ios/frameworkfiles/";
    xtools.copyDirEx(frameworkPath,config.iosRootPath()  + config.appName + "/");
}
...
function initPathEnv(){
    ...
    config.appName = store.getDefines().appName;
}
