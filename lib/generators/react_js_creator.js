...
function createClientReduxFlow(){
    ...
    //reducers
    createClientReduxItem("redux/index");
    createClientReduxItem("redux/homeReducer");
    createClientReduxItem("redux/listReducer");
    createClientReduxItem("redux/addReducer");
    createClientReduxItem("redux/updateReducer");
    createClientReduxItem("redux/deleteReducer");
