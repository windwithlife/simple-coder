...
var config = {
    ...
    targetWebRootPath:function(){return path.join(this.targetRootPath, "/autocoder/src/frontend/",this.language,"/")},
...
exports.coderDefine = {name:"rn",desc:"create a react js framework and related project code"};
